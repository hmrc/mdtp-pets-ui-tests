...
object ClientChoice extends BasePage {
  ...
  def selectCatAndSubmit(): Unit = {
    val catRadioButton: By = By.id("answers[journey1][pet-preference]-2")
    selectCheckbox(catRadioButton)
    click(continueButton)
  }

  def selectDogAndSubmit(): Unit = {
    val dogRadioButton: By = By.id("answers[journey1][pet-preference]")
